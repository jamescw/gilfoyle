...
df = pd.read_csv(
    "https://raw.githubusercontent.com/flyandlure/datasets/master/monthly-ecommerce-data.csv",
    skiprows=1,
    names=["Period", "Sessions", "Transactions", "Conversion Rate", "Revenue", "AOV"],
).head(13)
...
metrics = [
    ...
    pdf.add_metric_tile(
        metric_title="Revenue", metric_value_now=df["Revenue"].loc[0], metric_prefix="£"
    ),
]
